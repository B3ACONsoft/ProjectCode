...
public class MySQLiteHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_FK_LEAGUE_SPORT_ID   = "sport";
    ...
    public static final String CREATE_DATABASE =
            ...
            "CREATE TABLE " + TABLE_ENROLLMENT + " (" +
                    ...
                    COLUMN_FEE + " INTEGER," +
                    " PRIMARY KEY ("+ COLUMN_ENROLLMENT_ID +"), " +
            ...
            ("CREATE TABLE " + TABLE_PLACE + "( " +
             ...
             "CREATE TABLE " + TABLE_ATTENDANCE + "( " +
                    ...
                    COLUMN_FK_ATTENDANCE_EVENT_ID + "  event_id INTEGER," +
                    COLUMN_FK_ATTENDANCE_USER_ID + "  user_id  INTEGER," +
                    COLUMN_STATUS + " TEXT," +
                    COLUMN_MESSAGE + " TEXT," +
                    " PRIMARY KEY ("+ COLUMN_ATTENDANCE_ID +"), " +
    ...
    private static final String DATABASE_NAME = "bacon.db";
