...
public class DatabaseDummyLoader {
    ...
    public static String[] boom = {
            ...
            , "INSERT INTO users VALUES(NULL, 'HENRY', 'JOHNSON', 9194525758,  2323548302, 'A.A@YAHOO.COM', 'ADMIN', 'PASS');" //1
            ...
            , "INSERT INTO users VALUES(NULL, 'HENRY',     'JOHNSON',        9194525758, 2323548302, 'JOHNSONDH86@GMAIL.COM',            'COACH','PASS');"
            ...
            , "INSERT INTO users VALUES(NULL, 'PATRICIA',  'ARQUETTE',       9198127701, 8488372987, 'PATARQ@GODADDY.COM',                'USER','PASS');" //6
            , "INSERT INTO users VALUES(NULL, 'TIMOTHY',   'SWEET',          9198127701, 5467913468, 'HOTDUDE@SMELLSLIKEBACON.NET',       'USER','PASS');" //7
            , "INSERT INTO users VALUES(NULL, 'SNARKY',    'PARENT',         9198127701, 1485214852, 'IGAVEBIRTHTOSATAN@HITLERYOUTH.EDU', 'USER','PASS');" //8
            , "INSERT INTO users VALUES(NULL, 'TOM',       'CLANCY',         9198127701, 5848569587, 'TOOMANYCRIMENOVELS@MYDESK.COM',     'USER','PASS');" //9
            , "INSERT INTO users VALUES(NULL, 'KERRI',     'PLYMOUTH',       9198127701, 1547854256, 'LANDEDONMAY@THEROCK.COM',           'USER','PASS');" //10
            , "INSERT INTO users VALUES(NULL, 'BARRY',     'LONGFELLOW',     9198127701, 2563526589, 'STRETCH@ARMSTRONG.COM',             'USER','PASS');" //11
            , "INSERT INTO users VALUES(NULL, 'INPUT',     'M''DHATA',       9198127701, 0100100001, 'ONOFFOFFON@SOCKET.COM',             'USER','PASS');" //12
            , "INSERT INTO users VALUES(NULL, 'MESO',      'SAHOOP',         9198127701, 3164527548, 'HEALTHYLIVING@FAREAST.NET',         'USER','PASS');" //13
            , "INSERT INTO users VALUES(NULL, 'GUY',       'CLARK',          9198127701, 1245679185, 'LIVE@THEBLUEBIRDCAFE.COM',          'USER','PASS');" //14
            , "INSERT INTO users VALUES(NULL, 'CHERRIE',   'BERRY',          9198127701, 5487548151, 'LOVEINANELEVAT@AEROLIFT.COM',       'USER','PASS');" //15
            , "INSERT INTO users VALUES(NULL, 'COUNT',     'CHOCULA',        9198127701, 6664516666, 'ILOVETOCOUNTTHINGS@ANYWHERE.COM',   'USER','PASS');" //16
            , "INSERT INTO users VALUES(NULL, 'PATRICIA',  'ARQUETTE',       9198127701, 8488372987, 'PATARQ@GODADDY.COM',                'USER','PASS');" //17
            , "INSERT INTO users VALUES(NULL, 'TIMOTHY',   'SWEET',          9198127701, 5467913468, 'HOTDUD@SMELLS.NET',                 'USER','PASS');" //18
            , "INSERT INTO users VALUES(NULL, 'SNARKY',    'TEENAGER',       9198127701, 1485214852, 'IGAVEBIRTH@INYOUTH.EDU',            'USER','PASS');" //19
            , "INSERT INTO users VALUES(NULL, 'TOM',       'CLANCELLBAERRY', 9198127701, 5848569587, 'TOOMANYCRIMES@MYDESK.COM',          'USER','PASS');" //20
            , "INSERT INTO users VALUES(NULL, 'KARI',      'PRISON',         9198127701, 1547854256, 'LOVES@THEROCK.COM',                 'USER','PASS');" //21
            , "INSERT INTO users VALUES(NULL, 'BEAR',      'LONGFELLOW',     9198127701, 2563526589, 'STRETCHES@ARMSTRONG.COM',           'USER','PASS');" //22
            , "INSERT INTO users VALUES(NULL, 'OUTPUT',    'M''DHATASON',    9198127701, 0100100001, 'ONOFFOFFONOFF@SOCKET.COM',          'USER','PASS');" //23
            , "INSERT INTO users VALUES(NULL, 'MESA',      'SNOOP',          9198127701, 3164527548, 'HEALTHYLIVINGNOREALLY@FAREAST.NET', 'USER','PASS');" //24
            , "INSERT INTO users VALUES(NULL, 'GUYE',      'CLARKSON',       9198127701, 1245679185, 'LATER@THEBLUEBIRDCAFE.COM',         'USER','PASS');" //25
            , "INSERT INTO users VALUES(NULL, 'CHARLES',   'BARNES',         9198127701, 5487548151, 'LOVEINANELEVATAAA@AEROLIFT.COM',    'USER','PASS');" //26
            , "INSERT INTO users VALUES(NULL, 'COUNTESS',  'CHOCULA',        9198127701, 6664516666, 'INEVERLEARNEDTOREAD@THATSWHY.COM',  'USER','PASS');" //27
            , "INSERT INTO users VALUES(NULL, 'PRINCE',    'CHARLES',        9198127701, 4854558562, 'FAFAFAFA@DEARY.COM',                'USER','PASS');" //28
            , "INSERT INTO users VALUES(NULL, 'PRINCESS',  'MONOKE',         9198127701, 5525478845, 'IAMAPRINCESS@INJAPAN.COM',          'USER','PASS');" //29
            , "INSERT INTO users VALUES(NULL, 'PATRICK',   'CURRIN',         9198127701, 9196392121, 'CURRIN.PATRICK@GMAIL.COM',          'USER','PASS');" //30
            ...
            , "INSERT INTO event VALUES(NULL, 'PRACTICE', '2016/04/16 19:00:00', 1, 1, NULL);"
            , "INSERT INTO event VALUES(NULL, 'PRACTICE', '2016/04/17 19:00:00', 1, 2, NULL);"
            , "INSERT INTO event VALUES(NULL, 'PRACTICE', '2016/04/23 19:00:00', 2, 1, NULL);"
            , "INSERT INTO event VALUES(NULL, 'PRACTICE', '2016/04/24 19:00:00', 2, 2, NULL);"
            , "INSERT INTO event VALUES(NULL, 'PRACTICE', '2016/04/30 19:00:00', 3, 1, NULL);"
            , "INSERT INTO event VALUES(NULL, 'PRACTICE', '2016/05/01 19:00:00', 4, 2, NULL);"
